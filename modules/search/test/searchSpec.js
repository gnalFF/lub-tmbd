(function () {
    ...
    describe('search', function () {
        ...
        it('should search a movie via jsonp', inject(function (lubTmdbConfig, lubTmdbApiKey, lubTmdbApiSearch, $httpBackend) {
            ...
            $httpBackend.expectJSONP(lubTmdbConfig.baseURL + "search/movie?api_key=" + lubTmdbApiKey + '&callback=JSON_CALLBACK&query=Terminator').respond(200, {results:1});
        ...
        it('should search a collection via jsonp', inject(function (lubTmdbConfig, lubTmdbApiKey, lubTmdbApiSearch, $httpBackend) {
            ...
            $httpBackend.expectJSONP(lubTmdbConfig.baseURL + "search/collection?api_key=" + lubTmdbApiKey + '&callback=JSON_CALLBACK&query=Terminator').respond(200, {results:1});
        ...
        it('should search a list via jsonp', inject(function (lubTmdbConfig, lubTmdbApiKey, lubTmdbApiSearch, $httpBackend) {
            ...
            $httpBackend.expectJSONP(lubTmdbConfig.baseURL + "search/list?api_key=" + lubTmdbApiKey + '&callback=JSON_CALLBACK&query=Terminator').respond(200, {results:1});
